...
class HttpInterceptorHandler implements HttpHandler {
  constructor(private next: HttpHandler, private interceptor: HttpInterceptor, private accessToken: string) {}
...
export class HttpService extends HttpClient {
  ...
  request(method?: any, url?: any, options?: any): any {
    ...
    const accessToken = credentialsService.credentials && credentialsService.credentials.accessToken;
    const handler = this.interceptors.reduceRight(
      (next, interceptor) => new HttpInterceptorHandler(next, interceptor, accessToken),
      this.httpHandler
    );
